            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-pen"></i> Tambah Produksi</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.produksi.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ old('title') }}" placeholder="Masukkan Judul Produksi" class="form-control @error('title') is-invalid @enderror">
                            ...
                            {{-- <div class="form-group">
                                <label class="font-weight-bold">PERSETUJUAN</label>
                                <a class="btn btn-primary" href="#" role="button">P</a>
                                <select class="form-control" name="tags[]" multiple="multiple">
                                    @foreach ($tags as $tag)
                                        <option value="{{ $tag->id }}">{{ $tag->name }} </option>
                                    @endforeach
