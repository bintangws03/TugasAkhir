...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'posts.draft']);
        ...
        //permission for produksi
        Permission::create(['name' => 'produksi.index']);
        Permission::create(['name' => 'produksi.create']);
        Permission::create(['name' => 'produksi.edit']);
        Permission::create(['name' => 'produksi.delete']);
        ...
        //permission for riwayats
        Permission::create(['name' => 'riwayat.index']);
