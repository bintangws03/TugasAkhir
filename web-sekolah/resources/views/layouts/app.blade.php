...
<head>
    ...
    <title>Dashboard &mdash; SMKN 1 Jenangan</title>
    <link rel="shortcut icon" href="{{ asset('assets/img/stmj.png') }}" >
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html">SMKN 1 Jenangan</a>
                    </div>
                    <hr style="width: 50%">
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="index.html">STMJ</a>
                    </div>
                    <hr style="width: 50%">
                    <ul class="sidebar-menu">
                        ...
                        @can('jurusan.index')
                            <li class="{{ setActive('admin/jurusan')}}"><a class="nav-link" href="{{ route('admin.jurusan.index') }}"><i class="fas fa-list"></i>
                        <span>Jurusan</span></a></li>
                        @endcan

                        @can('prestasi.index')
                            <li class="{{ setActive('admin/prestasi') }}"><a class="nav-link" href="{{ route('admin.prestasi.index') }}"><i class="fas fa-trophy"></i>
                        <span>Prestasi</span></a></li>
                        @endcan

                        @can('produksi.index')
                            <li class="{{ setActive('admin/produksi') }}"><a class="nav-link" href="{{ route('admin.produksi.index') }}"><i class="fas fa-pen"></i>
                        <span>Unit Produksi</span></a></li>
                        @endcan
                        ...
                        <li>
                        @can('riwayat.index')
                        <li class="{{ setActive('admin/aktivitas') }}"><a class="nav-link" href="#"><i class="fas fa-history"></i>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2022 <div class="bullet"></div> SMKN 1 Jenangan <div class="bullet"></div> All Rights
                    Reserved.
                </div>
