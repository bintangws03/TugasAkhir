...
// prestasi
Route::get('/prestasi', [App\Http\Controllers\Api\PostController::class, 'index']);
Route::get('/prestasi/{id?}', [App\Http\Controllers\Api\PostController::class, 'show']);
Route::get('/homepage/prestasi', [App\Http\Controllers\Api\PostController::class, 'PrestasiHomePage']);