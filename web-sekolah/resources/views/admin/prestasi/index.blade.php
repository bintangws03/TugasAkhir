                            ...
                            <div class="input-group mb-3">
                                @can('prestasi.create')
                                    <div class="input-group-prepend">
                                        <a href="{{ route('admin.prestasi.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH</a>
                                    </div>
                                @endcan
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            @foreach ($prestasis as $no => $prestasi)
                                <tr>
                                    <th scope="row" style="text-align: center">{{ ++$no + ($prestasis->currentPage()-1) * $prestasis->perPage() }}</th>
                        ...
                        <div style="text-align: center">
                            {{$prestasis->links("vendor.pagination.bootstrap-4")}}
                        </div>
                    </div>
                </div>
            </div>
    ...
    function Delete(id)
        {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    //ajax delete
                    jQuery.ajax({
                        url: "{{ route("admin.prestasi.index") }}/"+id,
                        data:     {
                            "id": id,
                            "_token": token
                        },
