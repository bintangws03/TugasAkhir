        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-book-open"></i> Edit Produksi</h4>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.produksi.update', $produksi->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label>JUDUL PRODUKSI</label>
                            <input type="text" name="title" value="{{ old('title', $produksi->title) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select-category @error('category_id') is-invalid @enderror"
                                ...
                                @foreach ($categories as $category)
                                    @if($produksi->category_id == $category->id)
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control content @error('content') is-invalid @enderror" name="content"
                                ...
                                rows="10">{!! old('content', $produksi->content) !!}</textarea>
                            @error('content')
                            <div class="invalid-feedback" style="display: block">
                                {{ $message }}
                            </div>
